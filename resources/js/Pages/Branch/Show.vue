    ...
    <div>
        ...
        <div>
            <div v-for="branch in branch.children" class="flex items-center">
                <Link :href="route('branches.show', branch.id)" class="block w-full bg-white p-4 border border-gray-300">
                    <h3>{{ branch.title }}</h3>
                </Link>
                ...
                <Link :href="route('branches.destroy', branch.id)" class="block bg-red-600 p-4" method="delete">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-white">
